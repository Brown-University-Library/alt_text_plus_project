...
~~- Append each prompt and main response to the bottom of the file `alt_text_plus_project/recent_prompts.md`, followed by a blank-line, then `---`, then another blank-line -- if and only if that file exists.~~
- Ignore the above. 
